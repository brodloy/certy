...
<aside class="app-sidebar">
    ...
    <nav>
        ...
        <?php if (is_admin()): ?>
            ...
            <a class="nav-item-link<?= $path === '/admin' ? ' active' : '' ?>" href="<?= e(url('/admin')) ?>"><?= $icon('<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/>') ?>Admin dashboard</a>
            <a class="nav-item-link<?= str_starts_with($path, '/admin/runs') ? ' active' : '' ?>" href="<?= e(url('/admin/runs')) ?>"><?= $icon('<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>') ?>Scan runs</a>
